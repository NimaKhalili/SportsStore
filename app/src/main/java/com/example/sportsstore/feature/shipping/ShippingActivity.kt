...
import com.example.sportsstore.common.openUrlInCustomTab
...
import com.example.sportsstore.feature.checkout.CheckOutActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val onClickListener = View.OnClickListener {
            viewModel.submitOrder(
                ...
                .subscribe(object : SportsSingleObserver<SubmitOrderResult>(compositeDisposable) {
